...
public class DBConnection
{
    ...
    public void OpenDatabase(string dbFileName)
    {
        try
        {
            _sqliteConn = new SQLiteConnection("Data Source=" + dbFileName);
        }
    ...
    public void SaveMessageList(List<Message> msgList)
    {
        string inputString = "";
    ...
    private DataTable GetDataTable(string query)
    {
        ...
        {
            _sqliteConn.Open();
            SQLiteCommand command = new SQLiteCommand(_sqliteConn);
